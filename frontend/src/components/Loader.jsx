	...
	return (
		<div className="flex items-center justify-center min-h-screen">
			<div
				...
				role="status"
			>
				<div className="absolute inset-0 rounded-full blur-md opacity-20 bg-linear-to-tr from-[#002D5A] via-[#0892A5] to-[#C9910D]"></div>
					...
					<g className="origin-center animate-[spin_8s_linear_infinite]">
						...
						>
							...
							<g>
								...
								<g className="origin-center rotate-135">
									<line x1="60" y1="8" x2="60" y2="12"></line>
								</g>
